...
const routes = [
  ...
  {
    path: '/ios',
    Component: lazy(() => import('pages/dashboard/ios')),
    exact: true,
  },
  {
    path: '/android',
    Component: lazy(() => import('pages/dashboard/android')),
    exact: true,
  },
  {
    path: '/window',
    Component: lazy(() => import('pages/dashboard/window')),
    exact: true,
  },
  {
    path: '/mac',
    Component: lazy(() => import('pages/dashboard/mac')),
    exact: true,
  },
